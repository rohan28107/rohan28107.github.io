import { Box, Heading, Image, shouldForwardProp, chakra, SimpleGrid, Grid, Text  } from '@chakra-ui/react'
    ...
    <Box id="skills" height={["1250px","1050px","750px"]} className={Styles.Skills} padding="10px">
        ...
        <SimpleGrid columns={[1, 2, 3]} width="100%" height={["850px","800px","500px"]} gap={["10px","20px","30px"]} justifyContent={"center"}>
                <Box textAlign={"center"}  border="1px solid black" borderRadius="15px" padding={"15px"} >
                        ...
                        
                        {
                            FrontEnd.map((skills) => (
                                <Grid textAlign="center" justifyContent="center" id={skills.id} >
                                    ...
                                    <Image src={skills.img} alt='css' width={["40px","50px","90px"]} height={["40px","50px","90px"]} />
                                    <Heading as='h5' fontSize={["sm","lg","xl"]}>{skills.skillName}</Heading>
                                </Grid>
                            ))
                        }
                    </SimpleGrid>  
                 ...
                 <Box textAlign={"center"} border="1px solid black" borderRadius="15px" padding={"15px"}>
                    <Heading as="h2" fontSize={["md", "2xl"]} marginBottom={"20px"}>BackEnd</Heading>
                    ...
                    {/* columns={[2, 3, 3]} */}
                        {
                            Backend.map((skills) => (
                                <Grid textAlign="center" justifyContent="center" id={skills.id} >
                                    {/* justifyContent={"center"}  alignItems="center" */}
                                    <Image src={skills.img} alt='css' width={["40px","60px","90px"]} height={["40px","60px","90px"]} />
                                    <Heading as='h5' fontSize={["sm","lg","xl"]}>{skills.skillName}</Heading>
                                </Grid>
                            ))
                        }
                 ...
                 <Box textAlign={"center"} border="1px solid black" borderRadius="15px" padding={"15px"}>
                    <Heading as="h2" fontSize={["md", "2xl"]} marginBottom={"20px"}>Tools</Heading>
                    <SimpleGrid columns={3} gap="40px">
                        {
                            tools.map((skills) => (
                                <Grid textAlign="center" justifyContent="center" id={skills.id} >
